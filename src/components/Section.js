...
const Section = ({title='Section Title', image, isReversed=false, children}) => {
  ...
  <div className='flex flex-col lg:flex-row justify-center content-center mt-16 mx-auto'>
    ...
    <div>
      <div className={`flex bg-rose-100 text-red-500 text-4xl w-16 h-16 mr-auto ml-auto rounded-full mb-8 mt-16 justify-center items-center ${isReversed ? 'lg:mr-0' : 'lg:ml-0'}`} >
        $
      </div>
